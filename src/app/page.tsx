      ...
      <div className="flex flex-col items-center text-center py-8 sm:py-16 max-w-2xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif font-bold text-parchment-50 tracking-tight leading-tight">
            {language === 'ar' ? (
              <>
                طابق ذوقك مع قائمة المقهى في <span className="text-gold-400">٣ ثوانٍ</span>
              </>
            ) : (
              <>
          ...
          <div className="flex items-center justify-between border-b border-gold-500/15 pb-4">
            <div>
              <h2 className="text-lg font-bold text-parchment-50 font-serif">
                {language === 'ar' ? 'رحلة البداية المسبقة' : 'Pre-Visit Onboarding'}
              </h2>
              <p className="text-xs text-parchment-300/70">
                {language === 'ar' ? 'سجّل حسابك واكتشف لهجتك الذوقية قبل زيارة المقهى' : 'Create your profile & take the sensory quiz from home'}
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
            <div className="rounded-xl border border-espresso-700 bg-espresso-900/60 p-3.5 space-y-1.5">
              ...
              <div className="text-parchment-400 text-[11px]">
                {language === 'ar' ? '٤ خيارات لمس سريعة بدون استبيانات مملة' : '4 quick tactile taps, zero typing or friction'}
              </div>
            </div>
            ...
            <div className="rounded-xl border border-espresso-700 bg-espresso-900/60 p-3.5 space-y-1.5">
              ...
              <div className="font-semibold text-parchment-100">
                {language === 'ar' ? 'حساب دائم' : 'Persistent Account'}
              </div>
              <div className="text-parchment-400 text-[11px]">
                {language === 'ar' ? 'احفظ ذوقك وجوازك عبر جميع المقاهي الشريكة' : 'Carry your taste passport to Ambar, Turath & more'}
              </div>
            </div>
            ...
            <div className="rounded-xl border border-espresso-700 bg-espresso-900/60 p-3.5 space-y-1.5">
              ...
              <div className="font-semibold text-parchment-100">
                {language === 'ar' ? 'نموذج JEV' : 'JEV Decision Engine'}
              </div>
              <div className="text-parchment-400 text-[11px]">
                {language === 'ar' ? '٣ خيارات آمنة + ١ مغامرة للقضاء على الحيرة' : '3 safe matches + 1 adventure pick'}
              </div>
            </div>
          </div>
        </div>
