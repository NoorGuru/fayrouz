...
export function MatchView({
  ...
  return (
    <div className="w-full space-y-8 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-2xl border border-gold-500/20 bg-espresso-950/70 backdrop-blur-md">
      ...
      <div className="relative rounded-3xl border-2 border-gold-500/40 bg-gradient-to-br from-espresso-900 via-espresso-950 to-espresso-900 p-6 sm:p-8 shadow-2xl overflow-hidden text-left rtl:text-right space-y-6">
        {/* Ambient Hero Glow */}
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-2xl bg-gradient-to-r from-gold-500 via-gold-400 to-gold-600 px-6 py-4 text-base font-bold text-espresso-950 shadow-xl hover:from-gold-400 hover:to-gold-500 hover:shadow-gold-500/20 active:scale-[0.99] transition-all cursor-pointer"
        >
      ...
      <div className="space-y-4 text-left rtl:text-right">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {alternatives.map((alt, idx) => (
            <div
              key={alt.drink.id}
              className="rounded-2xl border border-espresso-700/80 bg-espresso-900/60 p-5 space-y-4 hover:border-gold-500/40 transition-all flex flex-col justify-between"
            >
      ...
      {adventurePick && (
        <div className="rounded-3xl border-2 border-fayrouz-500/40 bg-gradient-to-br from-espresso-950 via-espresso-900 to-espresso-950 p-6 sm:p-7 shadow-xl space-y-5 text-left rtl:text-right relative overflow-hidden">
