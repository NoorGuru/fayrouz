...
export function SensoryQuizModal({ isOpen, onClose, onCompleted }: SensoryQuizModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-espresso-950/85 backdrop-blur-md animate-in fade-in duration-200">
      <div
        className="relative w-full max-w-lg rounded-2xl glass-panel-glow border border-gold-500/30 bg-espresso-900/95 p-6 sm:p-8 shadow-2xl overflow-hidden"
